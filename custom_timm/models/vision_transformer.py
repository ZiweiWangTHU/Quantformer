...
__all__ = [
    ...
    'fpdeit_tiny_patch16_224',  'fpdeit_small_patch16_224',  'fpdeit_base_patch16_224',
]
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', quantization=False, **kwargs):
        """
        Args:
        ...
        if quantization == True:
            self.blocks = nn.Sequential(*[
                QBlock(
                    ...
                    act_layer=act_layer, **kwargs)
                for i in range(depth)])
        elif quantization == False:
            self.blocks = nn.Sequential(*[
                Block(
                    dim=embed_dim, num_heads=num_heads, mlp_ratio=mlp_ratio, qkv_bias=qkv_bias, qk_scale=qk_scale,
                    drop=drop_rate, attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer,
...
def deit_tiny_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=16, embed_dim=192, depth=12, num_heads=3, mlp_ratio=4, qkv_bias=True, quantization=True,
...
@register_model
def fpdeit_tiny_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
def deit_small_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=16, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4, qkv_bias=True, quantization=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.default_cfg = _cfg()
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
...
@register_model
def fpdeit_small_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
def deit_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
        patch_size=16, embed_dim=768, depth=12, num_heads=12, mlp_ratio=4, qkv_bias=True, quantization=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.default_cfg = _cfg()
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
...
@register_model
def fpdeit_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
